...
import PatientLowerExtremitiesAssessmentDialog from "./PatientLowerExtremitiesAssessmentDialog";
...
const LeaCard = () => {
    ...
    const url = `/patients/${id}/patient_lower_extremities_assessment`
    ...
    const doDeleteRecord = (e, recordId) => {
        alertUtils.showDeleteDialog(
          () => {
            useApi
            .delete(`/patients/${id}/patient_lower_extremities_assessment/${recordId}`, {})
            .then((res) => {
    ...
    const columns = [
        ...
        {
            name: "VISIT DATE",
            selector: (row) => [formattedDate(row.visit_date)],
        ...
        <>
            <Card>
                <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
                    <CardTitle tag='h4'>Lower Extremity Assessment</CardTitle>
                ...
                <div className='react-dataTable'>
                    ...
                    <PatientLowerExtremitiesAssessmentDialog
                        open={editOpen}
